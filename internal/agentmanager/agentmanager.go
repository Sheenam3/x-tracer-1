...
func New(containerId string, nodeId string, masterIp string, clientSet *kubernetes.Clientset, probes string, filepath string, funcname string) *agent {
	return &agent{
		containerId,
		nodeId,
		masterIp,
		clientSet, probes, filepath, funcname}
}
